  ...
  days: [
    ...
    /* ── Return Day 2 — Sun 28 Jun — Besançon to Vernon ─────────────── */
    {
      ...
      stops: [
        ...
        { id:"d6s2", order:2, time:"12:30", tz:"FR", location:"Tesla Supercharger Sens", type:"charging", priority:0, lat:48.1977, lng:3.2877, mapsUrl:"https://maps.google.com/?q=Tesla+Supercharger+Sens", reason:"Charge while enjoying a relaxed lunch to minimise journey time.", duration:60 },
        ...
        { id:"d6s4", order:4, time:"16:30", tz:"FR", location:"Vernon Riverside & Old Town", type:"architecture", priority:2, lat:49.0937, lng:1.4851, mapsUrl:"https://maps.google.com/?q=Vernon+France", reason:"Enjoy a relaxed wander through the old town and along the Seine before dinner.", duration:90 },
        { id:"d6s5", order:5, time:"19:00", tz:"FR", location:"Restaurant Libanais Tulip", type:"food", priority:3, lat:49.0937, lng:1.4851, mapsUrl:"https://maps.google.com/?q=Restaurant+Libanais+Tulip+Vernon", reason:"Lebanese cuisine provides a genuine range of vegan dishes rather than one token option.", veganFriendly:true, duration:105 },
        { id:"d6s6", order:6, time:"20:45", tz:"FR", location:"Hotel Le Normandy Vernon", type:"hotel", priority:0, lat:49.0940, lng:1.4848, mapsUrl:"https://maps.google.com/?q=Hotel+Le+Normandy+Vernon", reason:"Early night before visiting Monet's Gardens." }
      ],
      bucketListStops: [
    ...
    /* ── Return Day 3 — Mon 29 Jun — Vernon to Home ─────────────────── */
    {
      ...
      stops: [
        { id:"d7s1", order:1, time:"10:30", tz:"FR", location:"Hotel Le Normandy Vernon", type:"depart", priority:0, lat:49.0940, lng:1.4848, mapsUrl:"https://maps.google.com/?q=Hotel+Le+Normandy+Vernon", reason:"Short drive to Giverny.", routeUrl:"https://www.google.com/maps/dir/Hotel+Le+Normandy+Vernon/Fondation+Claude+Monet+Giverny/Tesla+Supercharger+Coquelles/LeShuttle+Calais" },
        ...
        { id:"d7s3", order:3, time:"13:45", tz:"FR", location:"Lunch in Giverny", type:"food", priority:3, lat:49.0762, lng:1.5345, mapsUrl:"https://maps.google.com/?q=Giverny", reason:"Relaxed lunch before beginning the journey home.", duration:75 },
        { id:"d7s4", order:4, time:"15:00", tz:"FR", location:"Depart Giverny", type:"depart", priority:0, lat:49.0762, lng:1.5345, mapsUrl:"https://maps.google.com/?q=Giverny", reason:"Leave with generous contingency for traffic." },
        { id:"d7s5", order:5, time:"17:15", tz:"FR", location:"Tesla Supercharger Coquelles", type:"charging", priority:0, lat:50.9283, lng:1.8167, mapsUrl:"https://maps.google.com/?q=Tesla+Supercharger+Coquelles", reason:"Charge only if required before LeShuttle.", duration:30 },
        { id:"d7s6", order:6, time:"17:45", tz:"FR", location:"LeShuttle Terminal Check-in, Calais", type:"transport", priority:0, lat:50.9513, lng:1.8587, mapsUrl:"https://maps.google.com/?q=LeShuttle+Calais", reason:"Aim to arrive around 2–2½ hours after your booked departure, preserving around 1½–2 hours of unused flexibility." },
        { id:"d7s7", order:7, time:"18:00", tz:"FR", location:"LeShuttle Crossing", type:"transport", priority:0, lat:50.9513, lng:1.8587, mapsUrl:"https://maps.google.com/?q=LeShuttle+Calais", reason:"Board the next available crossing within your Standard Plus flexibility window." },
        { id:"d7s8", order:8, time:"19:30", tz:"UK", location:"North Cadbury", type:"hotel", priority:0, lat:51.0333, lng:-2.5333, mapsUrl:"https://maps.google.com/?q=North+Cadbury", reason:"Arrive home after a relaxed final day." }
      ]
    }
  ]
};
