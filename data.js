  ...
  days: [
    ...
    /* ── Day 1 — Wed 17 Jun — North Cadbury to Amiens ─────────────── */
    {
      ...
      stops: [
        ...
        { id:"d1s6", order:6, time:"18:35", tz:"FR", location:"Saint-Valery-sur-Somme", type:"town", priority:2, lat:50.1833, lng:1.6333, mapsUrl:"https://maps.google.com/?q=Saint-Valery-sur-Somme+France", reason:"Outdoor harbour and old town stop; no vegan food is relied on here." },
        { id:"d1s7", order:7, time:"18:35", tz:"FR", location:"Harbour and Old Town Walk", type:"wander", priority:2, lat:50.1810, lng:1.6350, mapsUrl:"https://maps.google.com/?q=Port+de+Saint-Valery-sur-Somme+France", reason:"Open-air wander around the harbour, medieval streets and bay views.", duration:55 },
        { id:"d1s8", order:8, time:"19:30", tz:"FR", location:"Depart Saint-Valery-sur-Somme", type:"depart", priority:0, lat:50.1833, lng:1.6333, mapsUrl:"https://maps.google.com/?q=Saint-Valery-sur-Somme+France", reason:"Continue to Amiens." },
        { id:"d1s9", order:9, time:"20:45", tz:"FR", location:"Tesla Supercharger Amiens Dury", type:"charging", priority:0, lat:49.8390, lng:2.2870, mapsUrl:"https://maps.google.com/?q=Auchan+Amiens+Route+de+Paris+-+Dury+80000+Amiens+France", reason:"Exact Tesla location. Open 24/7; top up before hotel and Day 2.", duration:30 },
        { id:"d1s10", order:10, time:"21:15", tz:"FR", location:"Mian Miam, Amiens", type:"food", priority:2, lat:49.8934, lng:2.2975, mapsUrl:"https://maps.google.com/?q=Mian+Miam+12+Place+Parmentier+80000+Amiens+France", reason:"Vegan options listed; current hours show evening service until 22:30, so this timing works.", veganFriendly:true, duration:75 },
        { id:"d1s11", order:11, time:"22:30", tz:"FR", location:"Moxy Amiens", type:"hotel", priority:0, lat:49.8941, lng:2.2958, mapsUrl:"https://maps.google.com/?q=Moxy+Amiens+29-33+Rue+Paul+Tellier+80000+Amiens+France", reason:"Overnight stay." }
      ]
    },
    /* ── Day 2 — Thu 18 Jun — Amiens to Troyes ────────────────────── */
    {
      ...
      stops: [
        ...
        { id:"d2s2", order:2, time:"10:45", tz:"FR", location:"Hortillonnages d'Amiens", type:"experience", priority:3, lat:49.8978, lng:2.3138, mapsUrl:"https://maps.google.com/?q=Hortillonnages+d%27Amiens+54+Boulevard+de+Beauvill%C3%A9+80000+Amiens+France", reason:"Must-visit floating gardens; current boat departure window covers this arrival." },
        { id:"d2s3", order:3, time:"10:45", tz:"FR", location:"Hortillonnages Boat Tour", type:"experience", priority:3, lat:49.8978, lng:2.3138, mapsUrl:"https://maps.google.com/?q=Hortillonnages+d%27Amiens+54+Boulevard+de+Beauvill%C3%A9+80000+Amiens+France", reason:"Allow around 45 minutes for the boat and a little time around the site.", duration:60 },
        { id:"d2s4", order:4, time:"12:00", tz:"FR", location:"Le Colibri, Amiens", type:"food", priority:2, lat:49.8952, lng:2.2978, mapsUrl:"https://maps.google.com/?q=Le+Colibri+Amiens+13+Rue+Dusevel+80000+Amiens+France", reason:"HappyCow lists veganisable dishes and vegan cakes; current Thursday hours cover 12:00–13:00.", veganFriendly:true, duration:75 },
        { id:"d2s5", order:5, time:"13:15", tz:"FR", location:"Depart Amiens", type:"depart", priority:0, lat:49.8942, lng:2.3020, mapsUrl:"https://maps.google.com/?q=Amiens+France", reason:"Head towards Gerberoy." },
        { id:"d2s6", order:6, time:"14:30", tz:"FR", location:"Gerberoy", type:"village", priority:3, lat:49.4853, lng:1.8239, mapsUrl:"https://maps.google.com/?q=Gerberoy+France", reason:"Must-visit rose-covered medieval village — one of the most beautiful in France." },
        { id:"d2s7", order:7, time:"14:30", tz:"FR", location:"Gerberoy Wander", type:"wander", priority:3, lat:49.4853, lng:1.8239, mapsUrl:"https://maps.google.com/?q=Gerberoy+France", reason:"Open-air village walk through lanes, gardens and viewpoints.", duration:60 },
        { id:"d2s8", order:8, time:"15:30", tz:"FR", location:"Depart Gerberoy", type:"depart", priority:0, lat:49.4853, lng:1.8239, mapsUrl:"https://maps.google.com/?q=Gerberoy+France", reason:"Continue towards Troyes." },
        { id:"d2s9", order:9, time:"17:45", tz:"FR", location:"Tesla Supercharger Troyes Saint-Parres", type:"charging", priority:0, lat:48.3265, lng:4.0920, mapsUrl:"https://maps.google.com/?q=Centre+Commercial+Be+Green+Zone+commerciale+de+Saint-Parres-aux-Tertres+10410+Saint-Parres-aux-Tertres+France", reason:"Exact Tesla location. Open 24/7; charge before entering Troyes.", duration:35 },
        { id:"d2s10", order:10, time:"18:20", tz:"FR", location:"Troyes Old Town & Ruelle des Chats", type:"architecture", priority:3, lat:48.2968, lng:4.0735, mapsUrl:"https://maps.google.com/?q=Ruelle+des+Chats+Troyes+France", reason:"Must-visit half-timbered streets and medieval lanes." },
        { id:"d2s11", order:11, time:"19:00", tz:"FR", location:"Papillon, Troyes", type:"food", priority:2, lat:48.2968, lng:4.0735, mapsUrl:"https://maps.google.com/?q=Papillon+9+Ruelle+des+Chats+10000+Troyes+France", reason:"HappyCow says the vegetarian tasting menu can be made vegan with advance booking; current Thursday dinner hours are 19:00–21:00.", veganFriendly:true, duration:120 },
        { id:"d2s12", order:12, time:"21:00", tz:"FR", location:"B&B HOTEL Troyes Centre", type:"hotel", priority:0, lat:48.2990, lng:4.0760, mapsUrl:"https://maps.google.com/?q=B%26B+HOTEL+Troyes+Centre+51+Boulevard+du+14+Juillet+10000+Troyes+France", reason:"Overnight stay." }
      ]
    },
    /* ── Day 3 — Fri 19 Jun — Troyes to Beaune ────────────────────── */
    {
      ...
      stops: [
        ...
        { id:"d3s2", order:2, time:"12:00", tz:"FR", location:"Flavigny-sur-Ozerain", type:"village", priority:3, lat:47.5167, lng:4.5333, mapsUrl:"https://maps.google.com/?q=Flavigny-sur-Ozerain+France", reason:"Must-visit medieval village and anise sweet heritage." },
        { id:"d3s3", order:3, time:"12:00", tz:"FR", location:"Flavigny Wander", type:"wander", priority:3, lat:47.5167, lng:4.5333, mapsUrl:"https://maps.google.com/?q=Flavigny-sur-Ozerain+France", reason:"Open-air wander through the village, lanes and viewpoints.", duration:60 },
        { id:"d3s4", order:4, time:"13:30", tz:"FR", location:"Abbey of Fontenay", type:"architecture", priority:3, lat:47.6378, lng:4.3992, mapsUrl:"https://maps.google.com/?q=Abbaye+de+Fontenay+21500+Marmagne+France", reason:"Must-visit UNESCO abbey; current hours are 10:00–18:00 in June." },
        { id:"d3s5", order:5, time:"13:30", tz:"FR", location:"Fontenay Abbey Visit", type:"experience", priority:3, lat:47.6378, lng:4.3992, mapsUrl:"https://maps.google.com/?q=Abbaye+de+Fontenay+21500+Marmagne+France", reason:"Visit the buildings, gardens and exhibitions within published opening hours.", duration:90 },
        { id:"d3s6", order:6, time:"15:15", tz:"FR", location:"Tesla Supercharger Beaune Nord", type:"charging", priority:0, lat:47.0300, lng:4.8550, mapsUrl:"https://maps.google.com/?q=13+Rue+Gustave+Eiffel+21200+Beaune+France", reason:"Reliable location for the Teams presentation — charging, stable connectivity and nearby coffee." },
        { id:"d3s7", order:7, time:"16:00", tz:"FR", location:"Teams Presentation", type:"work", priority:0, lat:47.0300, lng:4.8550, mapsUrl:"https://maps.google.com/?q=13+Rue+Gustave+Eiffel+21200+Beaune+France", reason:"Present from the Tesla using stable mobile connectivity while charging.", duration:60 },
        { id:"d3s8", order:8, time:"17:00", tz:"FR", location:"Coffee and Buffer Time", type:"food", priority:0, lat:47.0300, lng:4.8550, mapsUrl:"https://maps.google.com/?q=13+Rue+Gustave+Eiffel+21200+Beaune+France", reason:"Contingency buffer if the meeting overruns.", duration:30 },
        { id:"d3s9", order:9, time:"17:45", tz:"FR", location:"ibis Styles Beaune Centre", type:"hotel", priority:0, lat:47.0230, lng:4.8370, mapsUrl:"https://maps.google.com/?q=ibis+Styles+Beaune+Centre+7+Boulevard+Perpreuil+21200+Beaune+France", reason:"Check in and freshen up." },
        { id:"d3s10", order:10, time:"18:30", tz:"FR", location:"Beaune Old Town", type:"architecture", priority:2, lat:47.0200, lng:4.8380, mapsUrl:"https://maps.google.com/?q=Hospices+de+Beaune+France", reason:"Evening wander around the historic centre." },
        { id:"d3s11", order:11, time:"19:30", tz:"FR", location:"Brasserie Le Carnot, Beaune", type:"food", priority:2, lat:47.0213, lng:4.8395, mapsUrl:"https://maps.google.com/?q=Brasserie+Le+Carnot+18+Rue+Carnot+21200+Beaune+France", reason:"HappyCow lists a clearly marked vegan dish; current Friday opening covers dinner.", veganFriendly:true, duration:90 },
        { id:"d3s12", order:12, time:"21:00", tz:"FR", location:"ibis Styles Beaune Centre", type:"hotel", priority:0, lat:47.0230, lng:4.8370, mapsUrl:"https://maps.google.com/?q=ibis+Styles+Beaune+Centre+7+Boulevard+Perpreuil+21200+Beaune+France", reason:"Overnight stay." }
      ]
    },
    ...
    /* ── Return Day 1 — Sat 27 Jun — Annecy to Besançon ─────────────── */
    {
      ...
      stops: [
        ...
        { id:"d5s5", order:5, time:"16:45", tz:"FR", location:"Besançon Old Town", type:"architecture", priority:2, lat:47.2378, lng:6.0241, mapsUrl:"https://maps.google.com/?q=Besancon+Old+Town+France", reason:"Riverside city walk with arcades, old streets and views." },
        { id:"d5s6", order:6, time:"19:00", tz:"FR", location:"L'Alsacien, Besançon", type:"food", priority:2, lat:47.2350, lng:6.0175, mapsUrl:"https://maps.google.com/?q=L%27Alsacien+Besancon+2+Quai+Vauban+25000+Besancon+France", reason:"HappyCow lists vegan flammkuchen; current Saturday opening runs late enough for dinner.", veganFriendly:true, duration:120 },
        { id:"d5s7", order:7, time:"21:00", tz:"FR", location:"B&B HOTEL Besançon Valentin", type:"hotel", priority:0, lat:47.2500, lng:6.0100, mapsUrl:"https://maps.google.com/?q=B%26B+HOTEL+Besan%C3%A7on+Valentin+3+Chemin+des+Trois+Croix+25480+Besan%C3%A7on+France", reason:"Overnight stay." }
      ]
    },
    /* ── Return Day 2 — Sun 28 Jun — Besançon to Rouen ─────────────── */
    {
      ...
      stops: [
        ...
        { id:"d6s3", order:3, time:"16:30", tz:"FR", location:"Fondation Claude Monet, Giverny", type:"experience", priority:3, lat:49.0762, lng:1.5345, mapsUrl:"https://maps.google.com/?q=Fondation+Claude+Monet+Giverny+84+Rue+Claude+Monet+27620+Giverny+France", reason:"Must-visit gardens; current 2026 hours are 10:00–18:00 with last admission at 17:30." },
        { id:"d6s4", order:4, time:"16:30", tz:"FR", location:"Giverny Visit", type:"experience", priority:3, lat:49.0762, lng:1.5345, mapsUrl:"https://maps.google.com/?q=Fondation+Claude+Monet+Giverny+84+Rue+Claude+Monet+27620+Giverny+France", reason:"Visit duration sits inside opening hours before 18:00 close.", duration:80 },
        { id:"d6s5", order:5, time:"19:00", tz:"FR", location:"Rouen Old Town", type:"architecture", priority:3, lat:49.4431, lng:1.0993, mapsUrl:"https://maps.google.com/?q=Rouen+Old+Town+France", reason:"Must-visit half-timbered streets and cathedral area." },
        { id:"d6s6", order:6, time:"19:30", tz:"FR", location:"Le Joubeil, Rouen", type:"food", priority:2, lat:49.4431, lng:1.0993, mapsUrl:"https://maps.google.com/?q=Le+Joubeil+52+Rue+des+Augustins+76000+Rouen+France", reason:"HappyCow lists vegan mezze and TheFork identifies it as open Sunday; book ahead.", veganFriendly:true, duration:120 },
        { id:"d6s7", order:7, time:"21:30", tz:"FR", location:"B&B HOTEL Rouen Centre Rive Droite", type:"hotel", priority:0, lat:49.4431, lng:1.0993, mapsUrl:"https://maps.google.com/?q=B%26B+HOTEL+Rouen+Centre+Rive+Droite+56+Quai+Gaston+Boulet+76000+Rouen+France", reason:"Overnight stay." }
      ]
    },
