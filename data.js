  ...
  days: [
    ...
    /* ── Day 2 — Thu 18 Jun — Amiens to Troyes ────────────────────── */
    {
      ...
      stops: [
        ...
        { id:"d2s10", order:8, time:"18:20", tz:"FR", location:"Troyes Old Town & Ruelle des Chats", type:"architecture", priority:3, lat:48.2968, lng:4.0735, mapsUrl:"https://maps.google.com/?q=Ruelle+des+Chats+Troyes+France", reason:"Must-visit half-timbered streets and medieval lanes." },
    ...
    /* ── Day 3 — Fri 19 Jun — Troyes to Beaune ────────────────────── */
    {
      ...
      stops: [
        ...
        { id:"d3s7", order:5, time:"16:00", tz:"FR", location:"Teams Presentation", type:"work", priority:0, lat:47.0300, lng:4.8550, mapsUrl:"https://maps.google.com/?q=13+Rue+Gustave+Eiffel+21200+Beaune+France", reason:"Present from the Tesla using stable mobile connectivity while charging.", duration:60 },
        { id:"d3s8", order:6, time:"17:00", tz:"FR", location:"Coffee and Buffer Time", type:"food", priority:0, lat:47.0300, lng:4.8550, mapsUrl:"https://maps.google.com/?q=13+Rue+Gustave+Eiffel+21200+Beaune+France", reason:"Contingency buffer if the meeting overruns.", duration:30 },
        ...
        { id:"d3s10", order:8, time:"18:30", tz:"FR", location:"Beaune Old Town", type:"architecture", priority:2, lat:47.0200, lng:4.8380, mapsUrl:"https://maps.google.com/?q=Hospices+de+Beaune+France", reason:"Evening wander around the historic centre." },
    ...
    /* ── Return Day 1 — Sat 27 Jun — Annecy to Besançon ─────────────── */
    {
      ...
      stops: [
        ...
        { id:"d5s5", order:4, time:"16:45", tz:"FR", location:"Besançon Old Town", type:"architecture", priority:2, lat:47.2378, lng:6.0241, mapsUrl:"https://maps.google.com/?q=Besancon+Old+Town+France", reason:"Riverside city walk with arcades, old streets and views." },
    ...
    /* ── Return Day 2 — Sun 28 Jun — Besançon to Rouen ─────────────── */
    {
      ...
      stops: [
        ...
        { id:"d6s5", order:4, time:"19:00", tz:"FR", location:"Rouen Old Town", type:"architecture", priority:3, lat:49.4431, lng:1.0993, mapsUrl:"https://maps.google.com/?q=Rouen+Old+Town+France", reason:"Must-visit half-timbered streets and cathedral area." },
