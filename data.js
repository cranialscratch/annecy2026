...
const TRIP_DATA = {
  ...
  days: [
    ...
    },
    {
      ...
      isFestival: true,
      stops: [
        { id:"show_tue1", order:0, time:"09:00", tz:"FR", type:"showing", title:"Discovering Nakalimutan, the Forgotten Island", location:"Bonlieu Scène nationale", duration:180, ticketed:false, queueMins:150, ownerOnly:true, lat:45.8998, lng:6.1296, mapsUrl:"https://maps.google.com/?q=Bonlieu+Scene+Nationale+Annecy", reason:"DreamWorks competition feature. Grande Salle — no ticket, queue up to 2.5 hrs early." },
    ...
    },
    {
      ...
      stops: [
        ...
        { id:"show_wed1", order:2, time:"11:00", tz:"FR", type:"showing", title:"Wildwood", location:"Cinéma de la Cité Internationale", duration:180, ticketed:false, queueMins:120, ownerOnly:true, lat:45.9012, lng:6.1332, mapsUrl:"https://maps.google.com/?q=Cinema+Cite+Internationale+13+Rue+de+la+Paix+Annecy", reason:"Festival screening at Cité Internationale. No ticket — queue required." },
        { id:"show_wed2", order:3, time:"11:00", tz:"FR", type:"showing", title:"Next on Netflix Animation", location:"Bonlieu Scène nationale", duration:240, ticketed:false, queueMins:150, ownerOnly:true, lat:45.8998, lng:6.1296, mapsUrl:"https://maps.google.com/?q=Bonlieu+Scene+Nationale+Annecy", reason:"Netflix Animation preview showcase. Grande Salle — no ticket, queue up to 2.5 hrs early." },
    ...
    },
    {
      ...
      stops: [
        ...
        { id:"show_thu1", order:3, time:"20:00", tz:"FR", type:"showing", title:"Walking with Animators #8", location:"Pathé Cinémas", duration:165, ticketed:false, queueMins:120, ownerOnly:true, lat:45.8965, lng:6.1308, mapsUrl:"https://maps.google.com/?q=Pathe+Cinemas+7+Avenue+de+Brogny+Annecy", reason:"Annual showcase of animators' personal films. A festival institution — held at Pathé." }
      ]
    },
    {
      id: "fest_fri",
      ...
      isFestival: true,
      stops: [
        { id:"show_fri1", order:1, time:"09:00", tz:"FR", type:"showing", title:"Walt Disney Showcase", location:"Bonlieu Scène nationale", duration:165, ticketed:false, queueMins:150, ownerOnly:true, lat:45.8998, lng:6.1296, mapsUrl:"https://maps.google.com/?q=Bonlieu+Scene+Nationale+Annecy", reason:"Walt Disney Animation Studios showcase. Grande Salle — no ticket, queue up to 2.5 hrs early." },
        { id:"show_fri2", order:2, time:"11:45", tz:"FR", type:"showing", title:"Pixar", location:"Bonlieu Scène nationale", duration:150, ticketed:false, queueMins:150, ownerOnly:true, lat:45.8998, lng:6.1296, mapsUrl:"https://maps.google.com/?q=Bonlieu+Scene+Nationale+Annecy", reason:"Pixar Animation Studios showcase. Grande Salle — no ticket, queue up to 2.5 hrs early." },
      ]
    },
